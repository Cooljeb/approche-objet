...
public class DixVillesDepartement extends MenuService{
    public DixVillesDepartement() {
    }
    @Override
    public void traiter(Recensement recensement, Scanner scanner) {
        scanner = new Scanner(System.in);
        System.out.println("\nAffichage des 10 villes les plus peuplées d'un département, saisir département !\n");
    ...
    void Ajouter(Recensement r, int c,HashMap<String,Integer> rp,Departement d){
        ...
        if((cdDepartement.equals(r.getMesCommunes().get(c).getDpt().getDepartement()))){
            ...
            //nombreHab=r.getMesCommunes().get(c).getPopTotale()+rp.get(nomVille);
